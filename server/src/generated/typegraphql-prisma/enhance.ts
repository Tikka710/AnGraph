...
const modelsInfo = {
  User: ["id", "name", "email"],
  Comment: ["id", "message", "user_id", "isEdit", "createdAt", "updatedAt"]
};
...
const outputsInfo = {
  ...
  CommentGroupBy: ["id", "message", "user_id", "isEdit", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  CommentCountAggregate: ["id", "message", "user_id", "isEdit", "createdAt", "updatedAt", "_all"],
  CommentAvgAggregate: ["id", "user_id"],
  CommentSumAggregate: ["id", "user_id"],
  CommentMinAggregate: ["id", "message", "user_id", "isEdit", "createdAt", "updatedAt"],
  CommentMaxAggregate: ["id", "message", "user_id", "isEdit", "createdAt", "updatedAt"]
};
...
const inputsInfo = {
  UserWhereInput: ["AND", "OR", "NOT", "id", "name", "email", "comment"],
  UserOrderByWithRelationInput: ["id", "name", "email", "comment"],
  ...
  CommentWhereInput: ["AND", "OR", "NOT", "id", "message", "user", "user_id", "isEdit", "createdAt", "updatedAt"],
  CommentOrderByWithRelationInput: ["id", "message", "user", "user_id", "isEdit", "createdAt", "updatedAt"],
  CommentWhereUniqueInput: ["id"],
  CommentOrderByWithAggregationInput: ["id", "message", "user_id", "isEdit", "createdAt", "updatedAt", "_count", "_avg", "_max", "_min", "_sum"],
  CommentScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "message", "user_id", "isEdit", "createdAt", "updatedAt"],
  UserCreateInput: ["name", "email", "comment"],
  UserUpdateInput: ["name", "email", "comment"],
  UserCreateManyInput: ["id", "name", "email"],
  UserUpdateManyMutationInput: ["name", "email"],
  CommentCreateInput: ["message", "user", "isEdit", "createdAt", "updatedAt"],
  CommentUpdateInput: ["message", "user", "isEdit", "createdAt", "updatedAt"],
  CommentCreateManyInput: ["id", "message", "user_id", "isEdit", "createdAt", "updatedAt"],
  CommentUpdateManyMutationInput: ["message", "isEdit", "createdAt", "updatedAt"],
  ...
  CommentCountOrderByAggregateInput: ["id", "message", "user_id", "isEdit", "createdAt", "updatedAt"],
  CommentAvgOrderByAggregateInput: ["id", "user_id"],
  CommentMaxOrderByAggregateInput: ["id", "message", "user_id", "isEdit", "createdAt", "updatedAt"],
  CommentMinOrderByAggregateInput: ["id", "message", "user_id", "isEdit", "createdAt", "updatedAt"],
  CommentSumOrderByAggregateInput: ["id", "user_id"],
  ...
  UserUpdateOneWithoutCommentInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  CommentCreateWithoutUserInput: ["message", "isEdit", "createdAt", "updatedAt"],
  ...
  CommentScalarWhereInput: ["AND", "OR", "NOT", "id", "message", "user_id", "isEdit", "createdAt", "updatedAt"],
  UserCreateWithoutCommentInput: ["name", "email"],
  UserCreateOrConnectWithoutCommentInput: ["where", "create"],
  UserUpsertWithoutCommentInput: ["update", "create"],
  UserUpdateWithoutCommentInput: ["name", "email"],
  CommentCreateManyUserInput: ["id", "message", "isEdit", "createdAt", "updatedAt"],
  CommentUpdateWithoutUserInput: ["message", "isEdit", "createdAt", "updatedAt"]
};
